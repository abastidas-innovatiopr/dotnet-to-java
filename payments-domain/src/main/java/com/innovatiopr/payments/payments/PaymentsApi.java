...
public interface PaymentsApi {
     ...
     */
    Result<UUID> transfer(String idempotencyKey, AccountId source, AccountId destination,
                          BigDecimal amount, String currencyCode, String reference);

    Result<UUID> deposit(AccountId accountId, BigDecimal amount, String currencyCode, String reference);

    Result<UUID> withdraw(AccountId accountId, BigDecimal amount, String currencyCode, String reference);
}
