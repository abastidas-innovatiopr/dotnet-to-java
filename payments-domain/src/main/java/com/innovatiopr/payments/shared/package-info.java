 ...
 * root package, which would force {@code Money} and the exception types into one flat package and destroy the
 ...
 * that uses it. It is kept deliberately small — value objects, the exception hierarchy, the error and
